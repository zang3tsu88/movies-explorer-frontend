...
function Header({ isLoggedIn }) {
  ...
  return (
    <>
      <header
        className={classNames("header", { "header_accent-clr": isLanding })}
      >
          ...
          {isLoggedIn ? (
            <>
              <div className="header__link-container">
                <NavLink
                  to="/movies"
                  className="link header__link header__link_type_movies"
                >
                  Фильмы
                </NavLink>
                <NavLink
                  to="/saved-movies"
                  className="link header__link header__link_type_saved-movies"
                >
                  Сохранённые фильмы
                </NavLink>
              </div>
            ...
            <>
              <Link
                to="/signup"
                className="link header__link header__link_type_signup"
              >
                Регистрация
              </Link>
              <Link
                to="/signin"
                className="link header__link header__link_type_login"
              >
                Войти
              </Link>
            </>
