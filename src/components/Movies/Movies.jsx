...
function Movies({ movies, handleRemoveMovie, handleLikeMovie, getBitFilms }) {
  ...
  const [query, setQuery] = useState(localStorage.getItem("queryMovies") || "");
  ...
  const filter = filterMovies(movies, query, shortFilmsOnly, movieCount);
